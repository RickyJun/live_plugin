...
import com.rick.live.live_plugin.camera.media.MediaRecorderBuilder;
...
import com.rick.live.live_plugin.camera.types.ResolutionPreset;
...
import static com.rick.live.live_plugin.camera.CameraUtils.computeBestPreviewSize;
...
public class Camera implements CameraDelegate {
  ...
  private void createCaptureSession(
          int templateType, final Runnable onSuccessCallback, SurfaceTexture cam, Surface... surfaces)
          throws CameraAccessException {
    this.cam = cam;
    ...
    cam.setDefaultBufferSize(previewSize.getWidth(), previewSize.getHeight());
    Surface flutterSurface = new Surface(cam);
            ...
            new CameraCaptureSession.StateCallback() {
              ...
              public void onConfigured(@NonNull CameraCaptureSession session) {
                ...
                refreshPreviewCaptureSession(
                        onSuccessCallback, new ErrorCallback() {
                          @Override
  ...
  private void refreshPreviewCaptureSession(
    ...
    } catch (@SuppressLint("NewApi") CameraAccessException | IllegalStateException | IllegalArgumentException e) {
            ...
            new ImageReader.OnImageAvailableListener() {
              ...
              public void onImageAvailable(ImageReader reader) {
                try (Image image = reader.acquireLatestImage()) {
                  ...
                  Camera.this.writeToFile(buffer, file);
  ...
  private final CaptureCallback pictureCaptureCallback =
      new CaptureCallback() {
        @RequiresApi(api = VERSION_CODES.LOLLIPOP)
        @Override
  ...
  private void runPicturePreCapture() {
    ...
    refreshPreviewCaptureSession(
            ...
            new ErrorCallback() {
              @Override
              public void onError(String code, String message) {
                pictureCaptureRequest.error(code, message, null);
              }
            });
  }
        ...
        null,
            new ErrorCallback() {
              ...
              public void onError(String errorCode, String errorMessage) {
                pictureCaptureRequest.error(errorCode, errorMessage, null);
              }
            });
  }
  ...
  public void startVideoRecording(Result result) {
    ...
    try {
      ...
      createCaptureSession(
          CameraDevice.TEMPLATE_RECORD, new Runnable() {
                @Override
                public void run() {
                  mediaRecorder.start();
                }
  ...
  public void setFlashMode(@NonNull final Result result, final FlashMode mode)
      throws CameraAccessException {
      ...
      case auto:
        refreshPreviewCaptureSession(
            null, new ErrorCallback() {
                  @Override
                  public void onError(String code, String message) {
                    result.error("setFocusMode", message, null);
                  }
                });
        break;
      case locked:
        ...
        Arrays.stream(availableDistortionCorrectionModes)
            .filter(new IntPredicate() {
              ...
              public boolean test(int value) {
                return value != CaptureRequest.DISTORTION_CORRECTION_MODE_OFF;
              }
            })
            .count();
  ...
  private Size getRegionBoundaries() throws CameraAccessException {
    ...
    if (VERSION.SDK_INT < VERSION_CODES.P || !supportsDistortionCorrection()) {
  ...
  public void startPreview(SurfaceTexture cam) throws CameraAccessException {
    if (pictureImageReader == null || pictureImageReader.getSurface() == null) return;

    createCaptureSession(CameraDevice.TEMPLATE_PREVIEW,null,cam, pictureImageReader.getSurface());
  }
