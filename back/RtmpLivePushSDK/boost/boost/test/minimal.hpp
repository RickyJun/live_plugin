...
#include "execution_monitor.ipp>
#include "debug.ipp>
#include "class_properties.hpp"
#include "io.hpp"

// Boost
#include "cstdlib.hpp"            // for exit codes#include "cstdlib.hpp"            // for exit codes
#include "current_function.hpp"   // for BOOST_CURRENT_FUNCTION
