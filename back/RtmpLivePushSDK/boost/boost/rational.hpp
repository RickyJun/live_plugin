...
#include "operators.hpp"   // for boost::addable etc
#include <cstdlib>               // for std::abs
#include "call_traits.hpp" // for boost::call_traits
#include "config.hpp"      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC
#include "workaround.hpp" // for BOOST_WORKAROUND
#include "assert.hpp"      // for BOOST_ASSERT
#include "common_factor_rt.hpp"  // for boost::math::gcd, lcm
#include <limits>                // for std::numeric_limits
#include "static_assert.hpp"  // for BOOST_STATIC_ASSERT
