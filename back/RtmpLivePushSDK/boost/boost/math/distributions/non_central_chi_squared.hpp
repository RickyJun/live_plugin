...
#include "fwd.hpp"
#include "gamma.hpp" // for incomplete gamma. gamma_q
#include "bessel.hpp" // for cyl_bessel_i
#include "round.hpp" // for iround
#include "complement.hpp" // complements
#include "chi_squared.hpp" // central distribution
#include "common_error_handling.hpp" // error checks
#include "fpclassify.hpp" // isnan.
#include "roots.hpp" // for root finding.
#include "generic_mode.hpp"
#include "generic_quantile.hpp"
