...
@end
@implementation GPUImageViewFlutterTexture
...
- (void)newFrameReadyAtTime:(CMTime)frameTime atIndex:(NSInteger)textureIndex;
{
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        glVertexAttribPointer(self->displayTextureCoordinateAttribute, 2, GL_FLOAT, 0, 0, ([GPUImageViewFlutterTexture textureCoordinatesForRotation:inputRotation]));
